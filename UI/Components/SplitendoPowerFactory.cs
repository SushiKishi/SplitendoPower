...
{
    public class SplitendoPowerFactory : IComponentFactory
    {
        // The displayed name of the component in the Layout Editor.
        public string ComponentName => "Splitendo Power";

        public string Description => "This component outputs a single text file that powers the backend of Splitendo Power notes.";

        // The sub-menu this component will appear under when adding the component to the layout.
        public ComponentCategory Category => ComponentCategory.Other;

        public IComponent Create(LiveSplitState state) => new SplitendoPowerComponent(state);
